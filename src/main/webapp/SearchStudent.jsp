...
<body>
	...
	<div id="partion">
		...
		<div class="container2">
			<h1 style="text-align: center; margin: 10px;">Search Student</h1>

			<div class="formbox2">

				<form action="SearchingStudent.jsp" method="post">

					<pre>Registration No. :     <input type="number" name="t1" placeholder="University registration number">  <input class="button-group-search-single" type="submit" value="Search Id" name="b1"></pre>

					<p style="text-align: center; margin: 0px;">OR</p>

					<pre>Student Name :         <input type="text" name="t2" placeholder="Enter Student Name">  <input class="button-group-search-single" type="submit" value="Search" name="b1"></pre>
