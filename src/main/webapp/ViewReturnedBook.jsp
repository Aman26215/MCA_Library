...
<nav id="navbar">
	...
	try {
		...
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/library", "root", "Admin@123");
			...
			PreparedStatement pstm = con.prepareStatement("SELECT BorrowId, BorrowRegister.BookId, BookName, BorrowRegister.StudentId, StudentName, StudentContact, IssueDate, ReturnDate from BorrowRegister inner join Book on BorrowRegister.BookId=Book.BookId inner join Student on BorrowRegister.StudentId=Student.StudentId WHERE ReturnDate IS NOT NULL ORDER BY BorrowId DESC");
	...
	<h1 style="text-align: center; margin: 10px;">Returned Book</h1>
	<div class="scroll2">
			<table>
