...
<body>
	...
	<div id="partion">
			...
			<nav id="navbar2">
				...
				<ul class="navul">
					...
					<li class="navli"><a class="nav-link" href="AddStudent.jsp">Add
							Student</a></li>
					<li class="navli"><a class="nav-link" href="SearchStudent.jsp">Search
							Student</a></li>
					...
					<li class="navli"><a class="nav-link" href="SearchBook.jsp">Search
							Book</a></li>
					<li class="navli"><a class="nav-link" href="ViewHistory.jsp">Borrow
							History</a></li>
					<li class="navli"><a class="nav-link"
						href="Returning.jsp?b1=Search All">Not Returned</a></li>
					<li class="navli"><a class="nav-link" href="Return.jsp">Return
							Book</a></li>
				</ul>
			</nav>
		</div>
		...
		<div class="container2">
			<h1 style="text-align: center; margin: 10px;">Return Books</h1>

			<div class="formbox2">
				<form action="Returning.jsp" method="post">

					<pre>Registration No. :     <input type="number" name="t2" placeholder="University registration number">  <input class="button-group-search-single" type="submit" value="Search By Student" name="b1"></pre>

					<p style="text-align: center; margin: 0px;">OR</p>

					<pre>Book Id :              <input type="number" name="t1" placeholder="Enter Book Id">  <input class="button-group-search-single" type="submit" value="Search By Book" name="b1"></pre>
